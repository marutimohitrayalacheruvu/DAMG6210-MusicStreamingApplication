...
INSERT INTO users (first_name, last_name, email, user_name, status, registration_date)
...
INSERT INTO artist (artist_fname, artist_lname, artist_bio, user_name)
SELECT 'Taylor', 'Swift', 'American singer', 'TAYLOR_SWIFT' FROM DUAL
UNION ALL
SELECT 'Justin', 'Bieber', 'Canadian singer', 'JUSTIN_BIEBER' FROM DUAL
UNION ALL
SELECT 'Nickie', 'Minaj', 'Trinidadian singer', 'NICKIE_MINAJ' FROM DUAL
UNION ALL
SELECT 'Adele', 'Adkins', 'British singer', 'ADELE_ADKINS' FROM DUAL
UNION ALL
SELECT 'Shawn', 'Mendes', 'Canadian singer-songwriter', 'SHAWN_MENDES' FROM DUAL;
