...
BEGIN
  insert_or_update_user('John', 'Doe', 'johndoe@example.com', 'john', 'active', SYSDATE);
END;
/
...
BEGIN
  insert_song('Song Name', 'Artist Name', 4.5, TO_TIMESTAMP('2022-03-29 12:30:00', 'YYYY-MM-DD HH:MI:SS'), 'English', TO_DATE('2022-03-29', 'YYYY-MM-DD'), 1, 1, 1, 1);
END;
/
...
BEGIN
  insert_playlist('Playlist Name', 1);
END;
/
